...
# Page configuration
st.set_page_config(
    page_title="Bitcoin Sentiment & Trading Analysis - By Amar Sharma",
    page_icon="📊",
    layout="wide",
    initial_sidebar_state="expanded",
    menu_items={
    'About': "Created by Amar Sharma | amarsharma358135@gmail.com | +91 9572549281"
    }
)
...
if page == "📋 Assignment Details":
    ...
    st.markdown("""
        <div class="author-card">
            ...
            <h1 style="margin: 20px 0;">Amar Sharma</h1>
            <p style="font-size: 20px; margin: 10px 0;">
                📧 Email: <a href="mailto:amarsharma358135@gmail.com" style="color: white; text-decoration: underline;">amarsharma358135@gmail.com</a>
            </p>
            <p style="font-size: 20px; margin: 10px 0;">
                📱 Phone: <a href="tel:+919572549281" style="color: white; text-decoration: underline;">+91 9572549281</a>
            </p>
        </div>
    """, unsafe_allow_html=True)
    ...
    <div style='text-align: center; padding: 30px; background-color: #f5f5f5; border-radius: 10px;'>
        ...
        <p style='font-size: 18px; margin: 15px 0;'>
            <b>Submitted by:</b> Amar Sharma
        </p>
        <p style='font-size: 16px; color: #666;'>
            📧 <a href="mailto:amarsharma358135@gmail.com">amarsharma358135@gmail.com</a> | 
            📱 +91 9572549281
        </p>
